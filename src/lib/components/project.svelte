...
<div class="w-full h-full flex justify-evenly sm:mx-32 flex-col {flipped ? 'md:flex-row-reverse' : 'md:flex-row'}">
    ...
    <div class="justify-center flex items-start">
        <img src="images/projects/{imageName}.webp" alt="Screenshot of {name}" class="dark:hidden drop-shadow-sm justify-center flex xl:h-[50vh]">
        <img src="images/projects/{imageName}-dark.webp" alt="Screenshot of {name}" class="drop-shadow-sm justify-center hidden dark:flex xl:h-[50vh]">
    </div>
    {:else}
    ...
    <div class="w-screen md:w-2/5 flex flex-col justify-center px-10 text-slate-700 dark:text-white">
        <div class="flex {flipped ? 'flex-row' : 'flex-row md:flex-row-reverse'}">
            ...
            <button class="inline hover:scale-102 px-2" on:click={() => {
                ...
                <svg xmlns="http://www.w3.org/2000/svg" class="w-14 fill-slate-700 dark:fill-white" viewBox="0 0 24 24"><path d="M8.465 11.293c1.133-1.133 3.109-1.133 4.242 0l.707.707 1.414-1.414-.707-.707c-.943-.944-2.199-1.465-3.535-1.465s-2.592.521-3.535 1.465L4.929 12a5.008 5.008 0 0 0 0 7.071 4.983 4.983 0 0 0 3.535 1.462A4.982 4.982 0 0 0 12 19.071l.707-.707-1.414-1.414-.707.707a3.007 3.007 0 0 1-4.243 0 3.005 3.005 0 0 1 0-4.243l2.122-2.121z"/><path d="m12 4.929-.707.707 1.414 1.414.707-.707a3.007 3.007 0 0 1 4.243 0 3.005 3.005 0 0 1 0 4.243l-2.122 2.121c-1.133 1.133-3.109 1.133-4.242 0L10.586 12l-1.414 1.414.707.707c.943.944 2.199 1.465 3.535 1.465s2.592-.521 3.535-1.465L19.071 12a5.008 5.008 0 0 0 0-7.071 5.006 5.006 0 0 0-7.071 0z"/></svg>
            </button>
        </div>
        <p class="text-base md:text-lg lg:text-xl {flipped ? 'sm:text-left' : 'sm:text-right'}">
            {description}
            <br/>
            {tools}
        </p>
